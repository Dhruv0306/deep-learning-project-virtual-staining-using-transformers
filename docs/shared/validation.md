# `shared/validation.py` — Validation Helpers

Source of truth: `../../shared/validation.py`
...
|---|---|---|
| `calculator` | `MetricsCalculator` | Metric computation object from `shared/metrics.py` |
